...
static void powerOnBacklight(bool);
...
static std::unique_ptr<HealthdDraw> healthd_draw = nullptr;
...
static void powerOnBacklight(bool on_flag) {
#ifdef BOARD_CHARGER_L01E

    static const char off[] = "0";
    static const char on[] = "128";

    if (on_flag) {
        android::base::WriteStringToFile(on, "/sys/class/leds/lcd-backlight/brightness");
    } else {  
