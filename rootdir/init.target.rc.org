...
service at_distributor /system/vendor/bin/at_distributor
    class late_start
    user root
...
service diag_uart_log /system/vendor/bin/diag_uart_log
    class main
    user root
    seclabel u:r:diag_uart_log:s0
    group radio

service SMD-daemon /system/vendor/bin/smdexe
    class main
    user root
    seclabel u:r:SMD-daemon:s0
    group system radio inet net_raw

service qc_kickstart /system/vendor/bin/qcks s
    class core
    user root
